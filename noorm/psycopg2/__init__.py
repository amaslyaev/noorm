"""
NoORM adapter for synchronous access to Postgres via psycopg2.
...
After decoration the decorated function receives an open Psycopg2 DB connection as a
...
# Usage:
with psycopg2.connect("postgresql://<<YOUR_DB>>") as conn:
